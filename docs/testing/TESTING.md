...
- Medicion web vigente: `99.61%` statements, `92.10%` branches, `98.22%` functions, `99.61%` lines con `220` suites y `2014` tests pasando (`2026-07-26`, Checkpoint 164).
...
- Objetivo final estrategico sigue siendo `98%` en ambos frentes. Web ya supera la meta en statements, functions y lines; branches (`92.10%`) es su frente pendiente. Game-server mantiene gates escalonados hasta acercarse a la meta sin falsos rojos.
