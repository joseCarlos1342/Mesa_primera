...
- Medicion web vigente: `99.49%` statements, `91.24%` branches, `98.03%` functions, `99.49%` lines con `218` suites y `1927` tests pasando (`2026-07-19`).
...
- Objetivo final estrategico sigue siendo `98%` en ambos frentes. Web ya supera la meta en statements, functions y lines; branches (`91.24%`) es su frente pendiente. Game-server mantiene gates escalonados hasta acercarse a la meta sin falsos rojos.
