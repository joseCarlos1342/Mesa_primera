...
- Medicion web vigente: `99.18%` statements, `88.34%` branches, `93.55%` functions, `99.18%` lines con `188` suites y `1495` tests pasando (`2026-06-22`).
...
- Gate operativo actual (subido tras Fase 2 del plan de hardening de cobertura):
  - Web: `89%` statements, `83%` branches, `85%` functions, `89%` lines.
