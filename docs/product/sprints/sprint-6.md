...
- **Alerta Oculta:** Inserta _flags_ de advertencia en `admin_audit_log` para que un operador los revise manualmente si nota un vaciado de cuentas sospechoso. (El diseño para una solución avanzada quedó documentado en `docs/security/mejoras_anti_colusion.md`).
