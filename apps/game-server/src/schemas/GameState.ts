...
export class GameState extends Schema {
  @type("string") phase: string = "LOBBY"; // LOBBY, STARTING, BARAJANDO, SORTEO_MANO, PIQUE_DEAL, PIQUE, PIQUE_REVEAL, COMPLETAR, APUESTA_4_CARTAS, DESCARTE, COMPLETAR_DESCARTE, REVELAR_CARTA, CANTICOS, DECLARAR_JUEGO, GUERRA, GUERRA_JUEGO, SHOWDOWN, SHOWDOWN_WAIT
