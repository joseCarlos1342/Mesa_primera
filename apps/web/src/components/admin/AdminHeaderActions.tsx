    ...
    <div className="flex items-center gap-2 sm:gap-3">
      ...
      {showLedgerBackShortcut ? (
        <Link
          ...
          className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-slate-100 transition-all duration-300 hover:border-white/20 hover:bg-white/10 active:scale-95 md:rounded-2xl shadow-[0_10px_30px_rgba(15,23,42,0.28)]"
        >
      ...
      {showBroadcastShortcut ? (
        <Link
          ...
          className="flex h-10 w-10 items-center justify-center gap-0 rounded-xl border border-indigo-500/30 bg-indigo-500/10 px-0 text-indigo-100 transition-all duration-300 hover:border-indigo-400/50 hover:bg-indigo-500/20 active:scale-95 sm:w-auto sm:gap-2 sm:px-4 md:rounded-2xl shadow-[0_10px_30px_rgba(49,46,129,0.2)]"
        >
      ...
      <SignOutButton
        variant="danger"
        className="h-10 w-10 justify-center px-0 py-0 sm:w-auto sm:px-4"
      />
    </div>
  )
}
