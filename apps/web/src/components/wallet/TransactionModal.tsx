          ...
          >
            ...
            <div className="relative z-10 p-6 md:p-8 flex items-center justify-between border-b border-brand-gold/10 shrink-0">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-sm font-display font-black text-brand-gold uppercase tracking-[0.2em] italic leading-none">Detalles de Operación</h3>
                  <p className="text-[10px] font-black text-text-secondary uppercase tracking-widest opacity-60 mt-1">Información de la Bóveda</p>
                </div>
              </div>
              <button 
                onClick={onClose}
            ...
            <div className="relative z-10 p-6 md:p-10 space-y-8 overflow-y-auto custom-scrollbar flex-1 min-h-0">
              ...
              <div className="text-center space-y-2">
                <h4 className="text-[10px] font-black text-text-secondary uppercase tracking-[0.4em] opacity-60">Monto Final</h4>
                <div className="flex flex-col items-center">
                   <p className={`text-6xl md:text-7xl font-display font-black italic tracking-tighter leading-none ${transaction.type === 'deposit' ? 'text-brand-gold' : 'text-text-premium'}`}>
                    {transaction.type === 'deposit' ? '+' : '-'}${(Math.abs(transaction.amount_cents || 0) / 100).toLocaleString()}
                  </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <DetailItem icon={Landmark} label="Tipo" value={transaction.type === 'deposit' ? 'Depósito de Fondos' : 'Retiro de Saldo'} />
