...
export function buildContentSecurityPolicy({
  ...
  return [
    ...
    `connect-src 'self' ${supabaseOrigin} wss://bhwchdzfvhhhuxovrqio.supabase.co ${gameServerOrigin} ${gameServerWsOrigin} ${livekitWss} ${livekitHttps} https://api.twilio.com https://verify.twilio.com https://basemaps.cartocdn.com https://*.basemaps.cartocdn.com`,
    `media-src 'self'`,
