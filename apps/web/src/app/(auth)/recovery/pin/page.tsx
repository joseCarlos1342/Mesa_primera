...
export default function RecoveryPinPage() {
      ...
      <div className="w-full max-w-md z-10 animate-in fade-in zoom-in-95 duration-1000">
        ...
        <div className="relative backdrop-blur-2xl bg-black/40 border-2 border-brand-gold/20 p-8 md:p-10 rounded-[2.5rem] shadow-[0_40px_80px_rgba(0,0,0,0.7)]">
          <div className="space-y-3 mb-10 text-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-green-500/10 border border-green-500/30 text-green-400 text-[12px] font-black tracking-widest uppercase mb-2">
              <KeyRound className="w-4 h-4" /> NUEVA CLAVE
            </div>
            <h2 className="text-3xl font-bold text-text-premium">Restablece tu Clave</h2>
            <p className="text-text-secondary text-base">
              Elige una nueva clave de <span className="text-brand-gold font-bold">6 dígitos</span>.
            </p>
          </div>
