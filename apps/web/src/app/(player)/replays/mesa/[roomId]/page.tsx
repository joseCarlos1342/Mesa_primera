    ...
    <div className="min-h-screen p-4 md:p-8 max-w-5xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-500 font-medium mt-1">
          {replays.length} {replays.length === 1 ? 'partida' : 'partidas'} en esta mesa
          <span className="ml-2 font-mono text-xs text-slate-600">({roomId.substring(0, 8)}…)</span>
        </p>
      </div>
      ...
      {replays.length === 0 ? (
        <div className="text-center py-20">
          ...
          <p className="text-slate-500 font-bold text-lg">No se encontraron grabaciones para esta mesa</p>
        </div>
      ) : (
