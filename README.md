...
*   **Autenticación en Modo "Demo":** El sistema de OTP por SMS (Twilio) está desactivado para evitar la recolección de datos personales. En su lugar, se han habilitado **20 perfiles colombianos reales** con identidad completa.
    *   **Cuentas de Evaluación (Listado Completo):**
        ...
        | **Jugador** | `andres_p` | Andres Pastrana | El Delfin | +57 316 666 7777 | 100.000 |
        | **Jugador** | `belisario_v` | Belisario Betancur | El Poeta | +57 304 888 9999 | 100.000 |
        | **Jugador** | `cesar_g` | Cesar Gaviria | El Economista | +57 310 222 3333 | 100.000 |
        | **Jugador** | `claudia_l` | Claudia Lopez | La Alcaldesa | +57 318 222 3333 | 100.000 |
        | **Jugador** | `daniel_q` | Daniel Quintero | El Pintoso | +57 301 444 5555 | 100.000 |
        | **Jugador** | `ernesto_s` | Ernesto Samper | El Elefante | +57 312 444 5555 | 100.000 |
        | **Jugador** | `fico_g` | Federico Gutierrez | El Paisa | +57 300 888 9999 | 100.000 |
        | **Jugador** | `gabo_marquez` | Gabriel Garcia | Gabo | +57 325 666 7777 | 100.000 |
        | **Jugador** | `gustavo_p` | Gustavo Petro | El Humilde | +57 302 444 5555 | 100.000 |
        | **Jugador** | `ivan_d` | Ivan Duque | El Guitarrista | +57 313 222 3333 | 100.000 |
        | **Jugador** | `jm_santos` | Juan Manuel Santos | Nobel | +57 305 000 1111 | 100.000 |
        | **Jugador** | `jorge_baron` | Jorge Baron | Señor Entusiasmo | +57 315 444 5555 | 100.000 |
        | **Jugador** | `rodolfo_h` | Rodolfo Hernandez | El Ingeniero | +57 317 666 7777 | 100.000 |
        | **Jugador** | `sergio_f` | Sergio Fajardo | El Profesor | +57 314 000 1111 | 100.000 |
        | **Jugador** | `u_velez` | Alvaro Uribe | El Capataz | +57 301 888 9999 | 100.000 |
        | **Jugador** | `virgilio_b` | Virgilio Barco | El Ingeniero | +57 300 000 1111 | 100.000 |
